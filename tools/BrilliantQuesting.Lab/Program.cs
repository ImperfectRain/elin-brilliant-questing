...
namespace BrilliantQuesting.Lab
{
    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            if (args.Length > 0 && args[0] == "--authority")
            {
                ulong authoritySeed = args.Length > 1 && ulong.TryParse(args[1], out ulong asked)
                    ? asked
                    : AuthorityRun.DefaultSeed;
                AuthorityRun.Run(authoritySeed);
                return 0;
            }
