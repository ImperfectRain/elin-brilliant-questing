...
**Working headless.** 150 tests. Deterministic simulation core: stable identity, event ledger,
...
evidence or testimony, and an auditor checks those links against the world. No Home state. No
economy. No sites. No NPC autonomy. No director. One situation archetype. Personality exists as
nine decision weights and is not yet expressed in dialogue. The scenario is staged by a debug flag,
not generated by the world.
