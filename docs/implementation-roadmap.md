...
**Working headless.** 160 tests. Deterministic simulation core: stable identity, event ledger,
...
explicit report outcomes for physical proof, witness-backed proof, unprovable belief and rumor. No
Home state. No economy. No sites. No NPC autonomy. No director. One situation archetype.
...
| Rumor propagation | Prototype | Hardened | BQ-019, BQ-020 |
