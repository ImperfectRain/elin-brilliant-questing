...
**Working headless.** 145 tests. Deterministic simulation core: stable identity, event ledger,
...
then routed through the consequence engine. No Home state. No economy. No sites. No NPC autonomy.
No director. One situation archetype. Personality exists as nine decision weights and is not yet
