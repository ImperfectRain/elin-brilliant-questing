...
**Working headless.** 204 tests. Deterministic simulation core: stable identity, event ledger,
...
on. No Home state. No economy. No sites. No NPC autonomy. No director. One situation archetype.
Personality exists as nine decision weights and is not yet expressed in dialogue. The scenario is
staged by a debug flag, not generated by the world.
