...
**Working headless.** 144 tests. Deterministic simulation core: stable identity, event ledger,
...
**Known gaps at the code level.** Vanilla theft is observed through `EVENT.ActPerformed`, with
witnesses derived from proximity, line of sight and stealth/perception. No Home state. No economy.
No sites. No NPC autonomy. No director. One situation archetype. Personality exists as nine
decision weights and is not yet expressed in dialogue. The scenario is staged by a debug flag, not
