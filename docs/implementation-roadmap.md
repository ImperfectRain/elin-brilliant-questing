...
**Working headless.** 221 tests. Deterministic simulation core: stable identity, event ledger,
fact/belief separation with provenance and provability, memory with consolidation, relationship
graph, threads with milestone escalation, fourteen verbs across six solution families, four-outcome
...
is, and derived from the edge rather than from any rule naming the pair. No Home state. No economy. No sites. No NPC autonomy. No
director. One situation archetype. Personality exists as nine decision weights and is not yet
