...
**Working headless.** 186 tests. Deterministic simulation core: stable identity, event ledger,
...
and never carrying proof. No Home state. No economy. No sites. No NPC autonomy. No director. One situation archetype.
...
| Rumor propagation | Playable | Hardened | BQ-019, BQ-020 |
