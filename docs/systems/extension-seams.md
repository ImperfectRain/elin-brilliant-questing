...
| Generation/archetypes | BQ-039–051/114/115/124/152; pressure-led establishment, recoverable outcomes, read-only actor requirements/proposal selection | BQ-103 costs can compare reuse/new-actor requirements before creation; hypothetical fulfillment remains owner responsibility. BQ-125/126 family weighting, setting seeds; reuse registry/facts/sites. [Generation](world.md#generation) |
