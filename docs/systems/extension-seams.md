...
| Generation/archetypes | BQ-039–051/103/114/115/124/152; pressure-led establishment, recoverable outcomes, read-only proposals with actor/premise creation costs; BQa-022 atomic Core recognition; BQa-023 independent property/damage/business matters sharing authoritative facts and single-dispatch effects | Other hypothetical fulfillment remains refused; ranking does not establish state. Recurring hosting is BQa-024; native multi-write creation has no atomic capability. BQ-125/126 family weighting, setting seeds; reuse registry/facts/sites. [Generation](world.md#generation) |
