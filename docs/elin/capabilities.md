...
| Home state/admission; household/shelter | Exact members/owner/capacity/admission SOURCE-OBSERVED, admission HEADLESS-ONLY; consult operation-specific runtime samples | [Home](api/home-and-settlements.md); [unresolved](verification/unresolved.md) 0009–0011 |
