...
| Home state/admission; household/shelter | September membership/capacity/skills read live; old zone probe failed. Corrected owner identity SOURCE-OBSERVED + HEADLESS-ONLY; admission unchanged | [Home](api/home-and-settlements.md); [unresolved](verification/unresolved.md) 0009–0011 |
