...
- BQ journal, chronicle, case notes, and debug report currently write to BepInEx log and notify the player via `Msg.SayRaw` as a fallback/debug surface (`VERIFIED-METADATA`, `VERIFIED-RUNTIME` for log route).
