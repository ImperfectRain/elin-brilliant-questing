...
| [`implementation-roadmap.md`](implementation-roadmap.md) | **BQ launch/hardening plan.** Remains authoritative for unfinished BQ work and acceptance. Queried by step, not read front to back. |
| [Living-world implementation roadmap](living-world-roadmap.md) | **Authoritative post-BQ plan.** Separate BQa sequence, start gate, causal contracts and public-beta acceptance. [Adoption audit](agent/bqa-roadmap-audit.md) explains corrections and renumbering. |
...
| [`design/procedural-places-and-spatial-history.md`](design/procedural-places-and-spatial-history.md) | Canonical spatial doctrine for procedural scenario dungeons, persistent sites, later generated settlements, additive place development, and the Elin evidence gates that keep physical mutation safe. |
