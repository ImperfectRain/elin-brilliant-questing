...
namespace BrilliantQuesting.Dialogue
{
    ...
    public sealed class DialogueRealizer
    {
        ...
        public RealizedLine Realize(RealizationRequest request)
        {
            ...
            RealizationReading reading = RealizationReading.Of(act, request.Decision, request.Claim, request.Cast, request.Callback);
        ...
        public IReadOnlyList<DialogueFragment> Candidates(FragmentPosition position, RealizationRequest request)
        {
            ...
            return Candidates(
                position,
                request,
                RealizationReading.Of(request.Act, request.Decision, request.Claim, request.Cast, request.Callback));
        }
